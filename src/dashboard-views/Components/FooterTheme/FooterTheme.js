        ...
        <div>
            <div className="footerbgblack">
                <div className="container">		
                    <div className="col-md-3">
                        ...
                        <div className="scont">
                        <a href="#" className="social1b"><img src="images/icon-facebook.png" alt /></a>
                        <a href="#" className="social2b"><img src="images/icon-twitter.png" alt /></a>
                        <a href="#" className="social3b"><img src="images/icon-gplus.png" alt /></a>
                        <a href="#" className="social4b"><img src="images/icon-youtube.png" alt /></a>
                        <br /><br /><br />
                ...
                <div className="col-md-3 grey">
                    ...
                    <button type="submit" className="btn btn-default btncustom">Submit<img src="images/arrow.png" alt /></button>
                    </div>
                    <br /><br />
            ...
            <div className="footerbg3black">
                <div className="container center grey"> 
                    ...
                    <a href="#">Blog</a> | 
                    <a href="#">Contact</a>
                    <a href="#top" className="gotop scroll"><img src="images/spacer.png" alt /></a>
                </div>
            </div>
        </div>
    )
